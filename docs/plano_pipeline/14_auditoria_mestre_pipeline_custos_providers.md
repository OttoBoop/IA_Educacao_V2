...
| GPT-5.4 Mini | `extrair_respostas` OK em duas amostras; demais etapas nao testadas | Smoke usou cadastro efemero `04b31001cf81`; teste de conexao retornou `OK`; `task_9c10e3752bcb` criou JSON `a39d26fcc621c7a8`, 4/7 respostas com conteudo real, 3/7 `MISSING_CONTENT`, tokens `97004/1942`, custo `US$ 0.081492`; cadastro revelou bugs de settings: `from-catalog` 500 e create basico ignorando capabilities. Patch `b16e051` foi deployado em `dep-d841ruu8bjmc73dbn030`, `from-catalog` passou no reteste criando `d1e2d1851836`, mas o cadastro por API anterior sumiu no deploy. Depois `gpt54mini001` entrou em `backend/data/models.json`, apareceu no site em `be19b7e`, testou conexao com `OK`; `task_706931a94555` criou `fec100a2e41eabcf`, 5/7 respostas reais, Q1/Q2 `MISSING_CONTENT`, Q3 `LOW_CONFIDENCE`, tokens `97004/1737`, custo `US$ 0.080570`; `task_19062336eb8b` criou `4a82ddf1d2118ff0`, 7/7 respostas reais, Q2/Q3 `LOW_CONFIDENCE`, tokens `90588/2813`, custo `US$ 0.0806` | Rodar pipeline per-phase antes de chamar de pipeline-ready. |
