...
| `4eaeb5105f5d` | Claude Sonnet 4.5 | `anthropic/claude-sonnet-4-5-20250929` | T/V | `3.00/15.00` | oficial Anthropic | ✅ | ✅ | ⏸️ | ⏸️ | ⏸️ | ⏸️ | ⏸️ nao testado | Falha historica `task_b19524abfdd5` por JSON em Markdown foi superada para `EXTRAIR_QUESTOES`: `task_b9eb22dbb753`, doc `147b412840c2b618`, `2257/461`, `US$0.013686`. Pos-`deb1e2a`, `EXTRAIR_GABARITO` passou em `task_f6f7260d5a77`, doc `ce57fd9cc1cbbdac`, `7731/1585`, `US$0.046968`, usage `usage_7a50263d5d16434c`, `record_count=10`. | `US$ 0.408816` | Proximo Sonnet, se houver objetivo de qualidade: `EXTRAIR_RESPOSTAS` isolado em Diana/Omega; nao rodar full antes de R/Corr. |
