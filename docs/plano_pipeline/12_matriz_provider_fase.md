...
| `4eaeb5105f5d` | Claude Sonnet 4.5 | `anthropic/claude-sonnet-4-5-20250929` | T/V | `3.00/15.00` | oficial Anthropic | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ Diana/Omega | Falha historica `task_b19524abfdd5` por JSON em Markdown foi superada para `EXTRAIR_QUESTOES`: `task_b9eb22dbb753`, doc `147b412840c2b618`, `2257/461`, `US$0.013686`. Etapas isoladas pós-`deb1e2a`: G `task_f6f7260d5a77`, R `task_70ecb29b3434`, Corr `task_baf5c638a3d8`, Hab `task_285f0f62a5cd`, Rel `task_a0dac5f0e565`. Full pipeline `task_80582211e0da`: seis etapas `completed`, sem `stage_errors`, Q `a7d0bc2c7dd26df5`, G `2ebd91546651be8e`, R `6c8774849c49340e`, Corr `ae83d94c78257e2d`/`d017033cc075c1d6`, Hab `74c427fad66dff70`/`a5b27c23e3f061ac`, Rel `c12bbcf3f4e79fcf`/`1e1129edafedbb44`, total `68172/23088`, `US$0.550836`; relatorio final com nota 8.0 e fontes Corr/Hab. | `US$ 0.408816` | Confirmado na fixture Diana/Omega, mas caro; proximo so se houver objetivo de qualidade ou dataset maior. |
