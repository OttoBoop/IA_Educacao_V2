...
def _check_chat_model_selection(model: dict) -> tuple[bool, str]:
    """
    Check that chat uses the correct model when model_id is specified (helper, not a pytest test).
...
def test_chat_model_selection_all():
    ...
    for model in test_models:
        ...
        success, details = _check_chat_model_selection(model)
