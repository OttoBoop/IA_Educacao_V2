"""
PROVA AI - Sistema de Armazenamento v2.0

Gerencia:
1. Banco de dados SQLite com nova estrutura hierárquica
...
class StorageManagerV2:
    """
    Gerenciador de armazenamento versão 2.
