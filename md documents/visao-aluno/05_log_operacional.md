...
| 2026-06-05 17:44 BRT | Deploy Render validado | Commit `5297c45` entrou no Render como deploy `dep-d8hj5itckfvc73avqktg`, status `live`. `/api/deploy-info` confirmou `source=RENDER_GIT_COMMIT`. |
| 2026-06-05 17:44 BRT | Smoke remoto da visao aluno | `GET /api/alunos/40ab839a5340e39a/visao` retornou Alvaro em Algebra Linear Avancada, turma `2026-1`, atividades `Lista0` e `Prova 01`. Playwright remoto gerou `logs/render-visao-aluno-alvaro-clean-2026-06-05.png`. |
| 2026-06-05 17:44 BRT | Smoke remoto do relatorio aluno-turma | `POST /api/executar/pipeline-desempenho-aluno-turma` gerou `relatorio_desempenho_aluno_turma` doc `49b70d1dba0b8f22`. Segunda chamada retornou `skipped=true`, sem duplicar. |
| 2026-06-05 18:15 BRT | Reprovado aceite do doc `49b70d1dba0b8f22` | O documento dizia `conteudo nao extraido automaticamente`; portanto nao era relatorio de desempenho, apenas artefato de escopo/persistencia. |
